...
export const metadata: Metadata = {
  title: "Disruptive AI - Israel's AI-Focused Venture Capital",
  description: "Disruptive AI is Israel's first VC specializing in artificial intelligence startups. We partner with passionate entrepreneurs from early-stage to growth with deep AI expertise and hands-on support.",
  keywords: "venture capital, AI, artificial intelligence, Israeli startups, early-stage funding, AI innovation",
  metadataBase: new URL("https://disruptiveai.fund"),
  alternates: {
    canonical: "https://disruptiveai.fund"
  },
  openGraph: {
    title: "Disruptive AI - Where AI Meets Disruption",
    description: "Israel's first AI-focused Venture Capital bringing unique advantage to early-stage startups",
    url: "https://disruptiveai.fund",
    siteName: "Disruptive AI",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SzEkxKoNyIbQ4hnQYui6BHsfB/uploaded-1765839188973-pag1luzk.jpg",
  ...
  twitter: {
    ...
    title: "Disruptive AI - Israel's AI Venture Capital",
    description: "Partnering with visionary AI entrepreneurs to create the future",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SzEkxKoNyIbQ4hnQYui6BHsfB/uploaded-1765839188973-pag1luzk.jpg"]
  },
  robots: {
    index: true,
    follow: true
